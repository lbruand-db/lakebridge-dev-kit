"""Tool-use agent loop for Tier 1 Lakebridge Reconcile skill tests.
...
def run_skill_agent(
    ...
    Args:
        ...
        system_prompt: Skill instructions (concatenated SKILL.md + reference files).
    ...
    for _ in range(max_turns):
        ...
        # Databricks FMAPI rejects empty content strings when tool_calls are
        # present, so only include content when it's non-empty.
